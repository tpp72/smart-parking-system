    ...
    <div class="sp-bg min-h-screen text-white">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-300 mt-1">เลือกการจองที่พร้อมเช็คอิน ระบบจะจัดช่องจอดให้อัตโนมัติ</p>
            </div>
            ...
            <div class="sp-card rounded-2xl p-6">
                @if ($reservations->isEmpty())
                    <p class="text-gray-400 text-center py-8">ไม่มีการจองที่พร้อมเช็คอินในขณะนี้</p>
                @else
