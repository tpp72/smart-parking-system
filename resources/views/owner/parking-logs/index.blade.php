        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-300 mt-1">ลานจอดของคุณ — ค้นหาตามทะเบียนรถ / กรองตามวันที่ — รถที่ยังไม่เช็คเอาท์ ทำ Manual Check-out ได้จากที่นี่</p>
                </div>
            </div>
                                    ...
                                    @if($isParked)
                                        <button type="button"
                                            ...
                                            @click="openCheckoutModal(
                                                ...
                                                {{ $hoursElapsed }},
                                                {{ $estimatedFee }},
                                                '{{ route('owner.reservations.check-out', $log->reservation_id) }}'
                                            )">
                                            เช็คเอาท์
                                        </button>
                                    @else
