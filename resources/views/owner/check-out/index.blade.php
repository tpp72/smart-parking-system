    ...
    <div class="sp-bg min-h-screen text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-300 mt-1">รถที่กำลังจอดอยู่ในลานของคุณ — กด Check-Out เพื่อคำนวณเงินและคืนช่องจอด</p>
            </div>
            ...
            <div class="sp-card rounded-2xl p-6 overflow-x-auto">
                @if ($logs->isEmpty())
                    <p class="text-gray-400 text-center py-8">ไม่มีรถที่กำลังจอดอยู่ในลานของคุณขณะนี้</p>
                @else
                        ...
                        <tbody>
                            @foreach ($logs as $log)
                                ...
                                <tr class="border-b sp-divider hover:bg-white/5 transition">
                                    ...
                                    <td class="py-3 pr-4">
                                        @if ($log->reservation)
                                            <span class="sp-badge sp-badge-ok text-xs whitespace-nowrap">
